...
export const METRICS: MetricDefinition[] = [
  ...
  metric({
    ...
    scope: ['player', 'globalCorrelation'],
    format: 'decimal',
    description: 'Win-rate gap between the best and worst starting seat.',
    formula: 'winRate(bestSeat) - winRate(worstSeat), negated when the best seat is the earlier one',
    meaning: 'Negative means earlier seats win more often, positive means later seats do, 0 means no measurable seat effect.',
    direction: 'neutral',
    decimals: 2,
  }),
  metric({
