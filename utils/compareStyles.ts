...
export const styles = StyleSheet.create({
  ...
  segmentActive: {
    backgroundColor: 'rgba(74, 98, 255, 0.24)',
    borderWidth: 1,
    borderColor: 'rgba(126, 238, 255, 0.84)',
    shadowColor: '#7DEBFF',
    shadowOpacity: 0.18,
    shadowRadius: 10,
  ...
  focusPillActive: {
    borderColor: 'rgba(125, 235, 255, 0.96)',
    backgroundColor: 'rgba(62, 96, 255, 0.24)',
    shadowColor: '#7DEBFF',
    shadowOpacity: 0.22,
    shadowRadius: 10,
    shadowOffset: { width: 0, height: 0 },
  ...
  presetPillActive: {
    borderColor: 'rgba(125, 235, 255, 0.96)',
    backgroundColor: 'rgba(88, 120, 255, 0.26)',
    shadowColor: '#7DEBFF',
    shadowOpacity: 0.22,
    shadowRadius: 10,
    shadowOffset: { width: 0, height: 0 },
  ...
  inlineSegmentActive: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(126, 238, 255, 0.80)',
    shadowColor: '#7DEBFF',
    shadowOpacity: 0.18,
    shadowRadius: 10,
    shadowOffset: { width: 0, height: 0 },
