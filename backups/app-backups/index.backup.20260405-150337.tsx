        ...
        <View style={styles.headerCard}>
          <View style={styles.headerTextWrap}>
            ...
            <Text style={styles.subtitle}>
              Live sentence builder and compact cohesion comparison, styled to match ELO.
            </Text>
          </View>
                    ...
                    {FOCUS_ITEMS.map((item) => {
                      ...
                      return (
                        <TouchableOpacity
                          ...
                          activeOpacity={0.9}
                          style={[styles.focusPill, active && styles.focusPillActive]}
                        >
                          <Text style={[styles.focusPillText, active && styles.focusPillTextActive]}>
                            {item.label}
                          </Text>
                        </TouchableOpacity>
                      );
