...
type StatCardTone = "default" | "accent" | "blue" | "green" | "amber" | "red";
...
function buildCustomTabCards(
  ...
  const currentElo = computeMetric("elo_current", rows);
  const peakElo = computeMetric("elo_peak", rows);
  const confidence = computeMetric("elo_confidence", rows);
      ...
      return {
        ...
        cards: [
          ...
          },
          {
            ...
            sub: `${wins} wins`,
            tone: winRate >= 0.6 ? "green" : winRate >= 0.45 ? "amber" : "red",
          },
          {
            key: "avgDelta",
            label: "Avg ELO Delta",
          ...
          },
          {
            ...
            tone: eloStd <= 10 ? "green" : eloStd <= 18 ? "amber" : "red",
          },
        ],
      };
        ...
        cards: [
          {
            ...
            tone: formScore >= 65 ? "green" : formScore >= 45 ? "amber" : "red",
          },
          {
            key: "recentDelta5",
          ...
          },
          {
            ...
            sub: "Immediate form",
            tone: recentWinRate3 >= 0.67 ? "green" : recentWinRate3 >= 0.34 ? "amber" : "red",
          },
          {
            key: "wr5",
            ...
            sub: "Rolling sample",
            tone: recentWinRate5 >= 0.6 ? "green" : recentWinRate5 >= 0.4 ? "amber" : "red",
          },
          {
            key: "wr10",
            ...
            sub: "Trend stability",
            tone: recentWinRate10 >= 0.6 ? "green" : recentWinRate10 >= 0.4 ? "amber" : "red",
          },
          {
            key: "currentStreak",
          ...
          },
          {
            ...
            tone: positiveDeltaRate >= 0.55 ? "green" : positiveDeltaRate >= 0.45 ? "amber" : "red",
          },
        ],
      };
        ...
        cards: [
          {
            ...
            tone: skillScore >= 65 ? "green" : skillScore >= 45 ? "amber" : "red",
          },
          {
            key: "favoredWinRate",
            ...
            tone: favoredWinRate >= 0.65 ? "green" : favoredWinRate >= 0.5 ? "amber" : "red",
          },
          {
            key: "underdogWinRate",
            ...
            tone: underdogWinRate >= 0.45 ? "green" : underdogWinRate >= 0.25 ? "amber" : "red",
          },
          {
            key: "avgOpponent",
          ...
          },
          {
            ...
            tone: currentElo >= avgOpponent ? "accent" : "amber",
          },
        ],
      };
        ...
        cards: [
          {
            ...
            tone: highOppWinRate >= 0.5 ? "green" : highOppWinRate >= 0.35 ? "amber" : "red",
          },
          {
          ...
          },
          {
            ...
            tone: postGameStd <= 20 ? "green" : postGameStd <= 35 ? "amber" : "red",
          },
        ],
      };
        ...
        cards: [
          {
            ...
            tone: projectionScore >= 65 ? "green" : projectionScore >= 45 ? "amber" : "red",
          },
          {
            key: "peakGapProj",
            ...
            tone: peakGap <= 20 ? "green" : peakGap <= 50 ? "amber" : "red",
          },
          {
            key: "confidenceProj",
            label: "Confidence",
            ...
            tone: confidence >= 0.7 ? "green" : confidence >= 0.5 ? "amber" : "red",
          },
          {
            key: "recentLift",
            label: "Recent Lift",
          ...
          },
          {
            ...
            tone: confidence >= 0.65 && eloStd <= 14 ? "green" : "amber",
          },
        ],
      };
  }
...
export default function PlayerProfileDetailScreen() {
  ...
  const currentElo = computeMetric("elo_current", filteredRows);
  const peakElo = computeMetric("elo_peak", filteredRows);
  const confidence = computeMetric("elo_confidence", filteredRows);
      ...
      >
        <View style={styles.headerCard}>
          <View style={styles.headerTextWrap}>
            ...
            <Text style={styles.title}>{selectedPlayer.name || "Player Profile"}</Text>
