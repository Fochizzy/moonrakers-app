      ...
      >
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.metricGrid}>
            ...
            <MetricCard
              label="Avg Prestige"
              value={globalStats.avgPrestige.toFixed(2)}
            />
            <MetricCard
              label="Avg Score"
              value={globalStats.avgScore.toFixed(2)}
            />
            <MetricCard
              label="Avg Contracts"
              value={globalStats.avgContracts.toFixed(2)}
            />
            <MetricCard
              label="Avg Assists"
              value={globalStats.avgAssists.toFixed(2)}
            />
            <MetricCard
              label="Failure Rate"
              value={`${(globalStats.failureRate * 100).toFixed(1)}%`}
            />
            <MetricCard
