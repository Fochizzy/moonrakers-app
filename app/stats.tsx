...
export default function StatsScreen() {
  ...
  const hasOverviewServerData =
    ...
    hasAvgSpreadValue ||
    hasChaosIndexValue ||
    // The merged form/closing and pressure clusters render inside the overview,
    // so they have to count as server data or they would be gated out.
        ...
        {playstyleHighlights.length > 0 || supportContextHighlight ? (
          <View style={styles.signalSection}>
            ...
            {supportContextHighlight ? (
              <View style={styles.playstyleSupportSpotlightCard}>
                ...
                <DefinitionTermText
                  ...
                  style={styles.playstyleSupportSpotlightLabel}
                />
                <Text style={styles.playstyleSupportSpotlightValue}>
  ...
  function renderGamesTab() {
    ...
    return (
      ...
      >
        ...
        ) : playerCountSummaryItems.length === 0 && !hasTurnOrderSections ? (
          <Text style={styles.emptyInlineText}>
...
const styles = StyleSheet.create({
  ...
  // Support Context Spotlight is a stacked card, distinct from the row-shaped
  // supporting-entry cards above, so it carries its own style names.
  playstyleSupportSpotlightCard: {
    borderRadius: 14,
    borderWidth: 1,
  ...
  playstyleSupportSpotlightLabel: {
    color: COLORS.textPrimary,
    fontSize: 13,
    fontWeight: "900",
  },
  playstyleSupportSpotlightValue: {
    color: COLORS.gold,
    fontSize: 12,
    fontWeight: "900",
  },
