...
assert.match(
  chartRouteSource,
  /<LineChart[\s\S]*data=\{serverChartData[\s\S]*players=\{serverChartPlayers/,
...
assert.match(
  chartRouteSource,
  /case "replay_chart":[\s\S]*<ReplayChart[\s\S]*replay=\{serverReplayData[\s\S]*players=\{serverChartPlayers/,
